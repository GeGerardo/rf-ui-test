...
Choose answer for Question 1/2, navigates, return and verifies
    ...
    Reset answer  ${RADIO_QUESTION_1_2}
    Go to the next question
    Select radio button answer    ${RADIO_QUESTION_1_1}
...
Go to Question 10 and select more than one checkbox
    ...
    Reset answer  ${BOX_QUESTION_10_2}
    Checkbox Should Not Be Selected    ${BOX_QUESTION_10_2}
    Select Checkbox    ${BOX_QUESTION_10_3}
